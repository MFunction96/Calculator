...
class ViewController: UIViewController {
    ...
    @IBAction func AcPow(_ sender: Any) {
    }
    ...
    @IBAction func AcPercent(_ sender: Any) {
    }
    @IBAction func AcDivide(_ sender: Any) {
    }
    @IBAction func AcSin(_ sender: Any) {
    }
    ...
    @IBAction func AcCos(_ sender: Any) {
    }
    ...
    @IBAction func AcLog(_ sender: Any) {
    }
